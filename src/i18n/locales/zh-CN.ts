export default {
    ...
    codePreview: "脚本代码",
    fileDetail: "附件详情",
    unsupportedPreview: "该文件类型暂不支持直接预览",
    openInNewWindow: "在新窗口中打开",
    browserDownload: "浏览器下载",
    batchRestore: "批量恢复",
    selectedCount: "已选择 {{count}} 项",
    batchRestoreConfirm: "确定要恢复选中的 {{count}} 项吗？",
};
